...
/**
 * PricesControllerIntegrationTest
 * 
...
public class PricesControllerIntegrationTest {
	...
	public void getAllTest1() throws Exception {
		...
		mockMvc.perform(get(baseUrl + "/price").params(params)).andDo(MockMvcResultHandlers.print())
				...
				.andExpect(jsonPath("$.price", Matchers.is(35.50)))
	...
	public void getAllTest2() throws Exception {
		...
		mockMvc.perform(get(baseUrl + "/price").params(params)).andDo(MockMvcResultHandlers.print())
				...
				.andExpect(jsonPath("$.productId", Matchers.is(35455)))
				.andExpect(jsonPath("$.brandId", Matchers.is(1)))
				.andExpect(jsonPath("$.startDate", Matchers.is("2020-06-14T15:00:00")))
				.andExpect(jsonPath("$.endDate", Matchers.is("2020-06-14T18:30:00")))
				.andExpect(jsonPath("$.price", Matchers.is(25.45)))
				.andExpect(jsonPath("$.currency", Matchers.is("EUR")))
				.andExpect(jsonPath("$.priceList", Matchers.is(2)));
	...
	public void getAllTest4() throws Exception {
		...
		mockMvc.perform(get(baseUrl + "/price").params(params)).andDo(MockMvcResultHandlers.print())
				...
				.andExpect(jsonPath("$.productId", Matchers.is(35455)))
				.andExpect(jsonPath("$.brandId", Matchers.is(1)))
				.andExpect(jsonPath("$.startDate", Matchers.is("2020-06-15T00:00:00")))
				.andExpect(jsonPath("$.endDate", Matchers.is("2020-06-15T11:00:00")))
				.andExpect(jsonPath("$.price", Matchers.is(30.50)))
				.andExpect(jsonPath("$.currency", Matchers.is("EUR")))
				.andExpect(jsonPath("$.priceList", Matchers.is(3)));
	...
	public void getAllTest5() throws Exception {
		...
		mockMvc.perform(get(baseUrl + "/price").params(params)).andDo(MockMvcResultHandlers.print())
				...
				.andExpect(jsonPath("$.endDate", Matchers.is("2020-12-31T23:59:59")))
				.andExpect(jsonPath("$.price", Matchers.is(38.95)))
				.andExpect(jsonPath("$.currency", Matchers.is("EUR")))
				.andExpect(jsonPath("$.priceList", Matchers.is(4)));
